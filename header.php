                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                ...
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>help@dreamrealestate.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/restatelg.png" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="team.php">Review Expert</a> </li>
									...
									<a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php">Post Property</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
