    ...
    <div class="row"> 
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Services</h2></div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Search Property</a></h5>
                                <p>User can search for the property into different locality of india from anywhere.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
					
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Review</a></h5>
                                <p>We are providing the review of property from the best engineers.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
			
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Property Locator</a></h5>
                                <p>The user will be also able to find properties in any specific region based upon his/her preference.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>The user can make the investment in the RealEstate which is a Legal.</p>
                            </div>
                        </div>
                    </div>
                </div>
